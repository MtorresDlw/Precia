...
module.exports = function($scope, $q, $state, orderService){
	...
	var PDFFILENAME = orderService.selectAttachment.DocumentId + ".pdf";
	...
	var pdfBase64 = orderService.selectAttachment.pdfBase64;
